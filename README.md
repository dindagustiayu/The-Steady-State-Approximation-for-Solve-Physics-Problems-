[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/dindagustiayu/The-Steady-State-Approximation-for-Solve-Physics-Problems-/blob/main/Steady-State%20Approximation.py)

# Simplify complex sytems of physics equations and chemical reactions.
1. In chemistry
...
plt.show()
```
![](https://github.com/dindagustiayu/The-Steady-State-Approximation-for-Solve-Physics-Problems-/blob/main/SSA%20svg/Particle%20Accelerator.svg)
...
plt.show()
```
![](https://github.com/dindagustiayu/The-Steady-State-Approximation-for-Solve-Physics-Problems-/blob/main/SSA%20svg/Capacitor%20Discharge%20(loop).svg)
...
plt.show()
```
![](https://github.com/dindagustiayu/The-Steady-State-Approximation-for-Solve-Physics-Problems-/blob/main/SSA%20svg/Capacitor%20Discharger%20(NumPy).svg)
...
plt.show()
```
![](https://github.com/dindagustiayu/The-Steady-State-Approximation-for-Solve-Physics-Problems-/blob/main/SSA%20svg/Kinetic%20Friction.svg)
